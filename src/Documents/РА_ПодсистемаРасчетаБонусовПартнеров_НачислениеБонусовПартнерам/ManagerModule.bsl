...
Функция ПолучитьДанныеДляПечатиАкта(МассивОбъектов) Экспорт
	...
	Запрос.Текст = 
		...
		|ИЗ
		|	Документ.РА_ПодсистемаРасчетаБонусовПартнеров_НачислениеБонусовПартнерам.НачисленияРучнойРасчет КАК РА_НачислениеБонусовПартнерамНачисленияРучнойРасчет
		|ГДЕ
