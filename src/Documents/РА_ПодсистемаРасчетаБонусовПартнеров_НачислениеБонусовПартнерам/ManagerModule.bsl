...
Функция ПолучитьДанныеДляПечатиАкта(МассивОбъектов) Экспорт
	...
	Запрос.Текст = 
		...
		|	РА_НачислениеБонусовПартнерамНачисленияАвтоматическийРасчет.БонуснаяПрограмма КАК БонуснаяПрограмма
		...
		|	РА_НачислениеБонусовПартнерамНачисленияРучнойРасчет.БонуснаяПрограмма
		|ИЗ
		...
		|	ВТ_ПодготовкаРасчета.БонуснаяПрограмма КАК БонуснаяПрограмма
		...
		|	ВТ_ПодготовкаРасчета.БонуснаяПрограмма
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|			И РА_НачислениеБонусовПартнерамНачисленияАвтоматическийРасчет.БонуснаяПрограмма = ВТ_ПодготовкаГруппировка.БонуснаяПрограмма
		|ГДЕ
		|	РА_НачислениеБонусовПартнерамНачисленияАвтоматическийРасчет.Ссылка В(&МассивОбъектов)
		|ИТОГИ ПО
		|	Ссылка";
