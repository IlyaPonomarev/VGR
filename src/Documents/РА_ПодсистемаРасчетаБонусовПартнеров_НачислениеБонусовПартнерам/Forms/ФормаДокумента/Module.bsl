...
Процедура НачисленияРучнойРасчетПроцентПремииПриИзменении(Элемент)
	...
	ТекДанные.Сумма = ТекДанные.БонусируемыйОборот * ТекДанные.ПроцентПремии / 100;
КонецПроцедуры
...
Процедура НачисленияРучнойРасчетСуммаБонусаПриИзменении(Элемент)
	ТекДанные = Элементы.НачисленияРучнойРасчет.ТекущиеДанные;
	ТекДанные.БонусируемыйОборот = ТекДанные.Сумма * 100 /ТекДанные.ПроцентПремии;
КонецПроцедуры

&НаКлиенте
Процедура НачисленияРучнойРасчетПриИзменении1(Элемент)
	Объект.СуммаБонусовИтого = Объект.НачисленияАвтоматическийРасчет.Итог("Сумма") + Объект.НачисленияРучнойРасчет.Итог("Сумма");
КонецПроцедуры

&НаКлиенте
Процедура НачисленияРучнойРасчетСтавкаНДСПриИзменении(Элемент)

	ТекущаяСтрока = Элементы.НачисленияРучнойРасчет.ТекущиеДанные;
