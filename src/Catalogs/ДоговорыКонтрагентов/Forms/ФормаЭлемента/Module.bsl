...
Процедура РА_ПодсистемаРасчетаБонусовПартнеров_ДобавитьЭлементыНаФорму()
	...
	НовыйЭлемент = Элементы.Добавить("РА_ТипДоговораДляБонусов", Тип("ПолеФормы"), Элементы.ГруппаШапкаЛево);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.РА_ПодсистемаРасчетаБонусовПартнеров_ТипДоговораДляБонусов";
